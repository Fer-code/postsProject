...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, (0, import_react16.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
Image2.defaultProps = defaultProps12;
...
Nav2.defaultProps = defaultProps15;
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime63.jsxs)(import_jsx_runtime62.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react46.cloneElement)(children, triggerProps), (0, import_jsx_runtime61.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Table = React76.forwardRef(({
  ...
  const classes = (0, import_classnames48.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React78.forwardRef((props, ref) => (0, import_jsx_runtime84.jsx)(Fade_default, {
  ...props,
  ref,
